...
abstract class AppLocalizations {
  ...
  /// No description provided for @noTasksTimeline.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Mon'**
  String get shortWeekdayMon;

  /// No description provided for @shortWeekdayTue.
  ///
  /// In en, this message translates to:
  /// **'Tue'**
  String get shortWeekdayTue;

  /// No description provided for @shortWeekdayWed.
  ///
  /// In en, this message translates to:
  /// **'Wed'**
  String get shortWeekdayWed;

  /// No description provided for @shortWeekdayThu.
  ///
  /// In en, this message translates to:
  /// **'Thu'**
  String get shortWeekdayThu;

  /// No description provided for @shortWeekdayFri.
  ///
  /// In en, this message translates to:
  /// **'Fri'**
  String get shortWeekdayFri;

  /// No description provided for @shortWeekdaySat.
  ///
  /// In en, this message translates to:
  /// **'Sat'**
  String get shortWeekdaySat;

  /// No description provided for @shortWeekdaySun.
  ///
  /// In en, this message translates to:
  /// **'Sun'**
