...
Todo _todoDeserialize(
  ...
  final object = Todo(
    ...
    ddl: reader.readDateTimeOrNull(offsets[1]),
    description: reader.readStringOrNull(offsets[2]) ?? '',
    id: id,
    importance: reader.readLongOrNull(offsets[3]) ?? 1,
    isCompleted: reader.readBoolOrNull(offsets[4]) ?? false,
    startDate: reader.readDateTimeOrNull(offsets[5]),
    taskType: _TodotaskTypeValueEnumMap[reader.readByteOrNull(offsets[6])] ??
        TaskType.task,
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> ddlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'ddl',
      ));
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> ddlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'ddl',
      ));
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> ddlEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'ddl',
        value: value,
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> ddlGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> ddlLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> ddlBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> importanceEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortByDdl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ddl', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortByDdlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ddl', Sort.desc);
    });
  }
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenByDdl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ddl', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenByDdlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ddl', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctByDdl() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'ddl');
    });
  }
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, DateTime?, QQueryOperations> ddlProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'ddl');
    });
  }
  ...
  QueryBuilder<Todo, int, QQueryOperations> importanceProperty() {
    return QueryBuilder.apply(this, (query) {
